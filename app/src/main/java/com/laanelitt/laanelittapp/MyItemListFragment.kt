 ...
 * Use the [MyItemListFragment.newInstance] factory method to
...
class MyItemListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val layout= inflater.inflate(R.layout.fragment_my_item_list, container, false)
